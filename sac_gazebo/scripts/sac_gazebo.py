...
if __name__ == '__main__':
    ...
    # path = '/home/ricardo/catkin_ws/src/deep_rl_hydrone_gazebo/sac_gazebo/scripts/model/sac/'
    ...
    agent = SACAgent(alpha=alpha, beta=beta, input_dims=env.observation_space, tau=tau, max_action=1.0, \
                        batch_size=bs, layer1_size=512, layer2_size=512, reward_scale=2, n_actions=env.action.shape[0], \
                        path_dir=path)
