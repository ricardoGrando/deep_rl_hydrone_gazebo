...
class TD3Agent():
    def __init__(self, alpha, beta, input_dims, tau, max_action, min_action, gamma=0.99, update_actor_intervals=2, warmup=1000, \
        ...
        self.update_actor_iter = update_actor_intervals
